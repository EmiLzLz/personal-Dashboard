...
function SummaryCard({ title, icon: Icon, endpoint }) {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute -top-2 left-6 bg-pink-500 rounded-xl p-4 shadow-xl drop-shadow-lg z-10">
        <Icon className="icon w-6 h-6 text-white" />
      </div>

      <div className="summary-card-container w-full sm:w-80 hover-effect relative p-6 pt-4 bg-white rounded-xl shadow-sm flex flex-col mt-4">
        ...
        <div className="ml-auto text-right mt-4">
          ...
          <div className="total text-4xl font-bold text-gray-800 mb-2">
            {totalData}
          </div>
